...
class RealColonPre(Dataset):
    def __init__(self, data_mode='train', input_size=336, **kwargs):
        super().__init__()
        input_size = 336
        self.pic_root = Path('/home/star/datasets/wxh/real_colon_clip_pics_full')
        self.depth_root = Path('/home/star/datasets/wxh/real_colon_clip_pics_est_full')
