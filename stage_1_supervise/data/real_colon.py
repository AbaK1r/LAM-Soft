...
class RealColon(Dataset):
    def __init__(self, input_size=352, **kwargs):
        ...
        self.root_dir = Path('/home/star/datasets/wxh/real_colon_clip_pics_full/')
        ...
        #     transforms.ToTensor(),
        # ])
        self.file = list(self.root_dir.glob('*.jpg'))

        # with np.load('/home/star/datasets/wxh/real_colon_clip/calibration.npz') as data:
        #     intrinsics = data['K']
